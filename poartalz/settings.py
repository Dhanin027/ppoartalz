...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Your static files folder for development
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Folder where static files will be collected in production
